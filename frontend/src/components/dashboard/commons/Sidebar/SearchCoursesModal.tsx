      ...
      >
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-bold text-gray-800">Search Courses</h2>
            <button
              onClick={onClose}
          ...
          <input
            ...
            placeholder="Search by course code, number, or title..."
        ...
        <div className="p-6">
          {courses.loading ? (
            ...
            <div className="text-center text-gray-500 py-8">
              {searchTerm ? 'No courses found matching your search' : 'Type to search for courses'}
            </div>
          ) : (
